...
/**
 * struct data - Structure for holding shell data
 * @av: Argument vector
 * @input: User input
 * @args: Parsed arguments
 * @status: Exit status
 * @counter: Counter for some purpose
...
/**
 * struct sep_list_s - Structure for separator list
...
/**
 * struct line_list_s - Structure for line list
 * @line: Line string
...
/**
 * struct r_var_list - Structure for variable list
